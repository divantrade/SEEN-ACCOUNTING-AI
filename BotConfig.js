...
const BOT_CONFIG = {
    ...
    COMMAND_LIST: [
        ...
        { command: 'exchange', description: '💱 تغيير عملة (تصريف)' },
    ...
    KEYBOARDS: {
        ...
        TRANSACTION_TYPE: {
            inline_keyboard: [
                ...
                [
                    { text: '✂️ تسوية استحقاق مصروف', callback_data: 'nature_تسوية استحقاق مصروف' },
                    { text: '✂️ تسوية استحقاق إيراد', callback_data: 'nature_تسوية استحقاق إيراد' }
                ],
                [
                ...
                [
                    ...
                    { text: '💱 تغيير عملة', callback_data: 'nature_تغيير عملة' }
                ],
                [
                    { text: '🏦 مصاريف بنكية', callback_data: 'nature_مصاريف بنكية' }
                ],
                [
        ...
        CLASSIFICATION_EXCHANGE: {
            inline_keyboard: [
                [
                    { text: '💵→💱 بيع دولار (دولار ← ليرة)', callback_data: 'class_بيع دولار' },
                ],
                [
                    { text: '💱→💵 شراء دولار (ليرة ← دولار)', callback_data: 'class_شراء دولار' }
                ],
                [
                    { text: '❌ إلغاء', callback_data: 'cancel' }
                ]
...
💱 /تغيير - لتغيير عملة (تصريف دولار ↔ ليرة)
